  ...
  return (
    <div className="mx-auto py-16 prose lg:prose-xl text-center">
      ...
      {router.asPath !== '/' && mapsAddress && (
        <div className={`relative h-0 pb-[56.25%] overflow-hidden max-w-screen-md my-16 not-prose`}>
          <iframe
            title="Maps"
            ...
            src={`https://www.google.com/maps/embed/v1/place?key=${process.env.mapsKey}&q=${mapsAddress.replaceAll(
              ' ',
              '+'
            )}`}
            allowFullScreen
